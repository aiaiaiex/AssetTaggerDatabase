...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Descending sort.
            ...
            CASE WHEN ((@SortOrder = 'DESC') AND (@SortColumn = 'ProductQuantity')) THEN ProductQuantity END DESC,
            -- Ascending sort.
            ...
            CASE WHEN ((@SortOrder = 'ASC') AND (@SortColumn = 'ProductQuantity')) THEN ProductQuantity END ASC
            -- Pagination.
