...
BEGIN
    ...
    DECLARE @TableName NVARCHAR(836) = 'Building';
    ...
    BEGIN TRY
        ...
        -- Descending sort.
            ...
            CASE WHEN ((@SortOrder = 'DESC') AND (@SortColumn = 'Address')) THEN Address END DESC,
            -- Ascending sort.
            ...
            CASE WHEN ((@SortOrder = 'ASC') AND (@SortColumn = 'Address')) THEN Address END ASC
            -- Pagination.
