CREATE TABLE [dbo].[Company] (
    ...
    CONSTRAINT [CK_Company_CompanyName_NoTrailingWhitespace] CHECK ([CompanyName] NOT LIKE ' %' AND [CompanyName] NOT LIKE '% '),
    ...
    CONSTRAINT [CK_Company_CompanyAddress_NoTrailingWhitespace] CHECK ([CompanyAddress] NOT LIKE ' %' AND [CompanyAddress] NOT LIKE '% '),
    ...
    CONSTRAINT [CK_Company_CompanyCode_NoTrailingWhitespace] CHECK ([CompanyCode] NOT LIKE ' %' AND [CompanyCode] NOT LIKE '% '),
