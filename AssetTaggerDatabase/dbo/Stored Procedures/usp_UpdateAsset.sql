CREATE PROCEDURE [dbo].[usp_UpdateAsset]
    ...
    @AssetPurchaseDate DATETIME = '1753-01-01 00:00:00.000',
    @AssetPurchasePrice DECIMAL(19, 4) = -999999999999999.9999,
    ...
    @AssetSalvageValue DECIMAL(19, 4) = -999999999999999.9999
AS;
BEGIN
    SET NOCOUNT ON;
