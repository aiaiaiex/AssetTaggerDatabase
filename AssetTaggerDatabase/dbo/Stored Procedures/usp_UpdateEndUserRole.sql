...
BEGIN
    ...
    SET
        ...
        HasCreatingAssetPermission = ISNULL(@HasCreatingAssetPermission, HasCreatingAssetPermission),
        HasReadingAssetPermission = ISNULL(@HasReadingAssetPermission, HasReadingAssetPermission),
        HasUpdatingAssetPermission = ISNULL(@HasUpdatingAssetPermission, HasUpdatingAssetPermission),
        HasDeletingAssetPermission = ISNULL(@HasDeletingAssetPermission, HasDeletingAssetPermission),
        HasCreatingAssetFixPermission = ISNULL(@HasCreatingAssetFixPermission, HasCreatingAssetFixPermission),
        HasReadingAssetFixPermission = ISNULL(@HasReadingAssetFixPermission, HasReadingAssetFixPermission),
        HasUpdatingAssetFixPermission = ISNULL(@HasUpdatingAssetFixPermission, HasUpdatingAssetFixPermission),
        HasDeletingAssetFixPermission = ISNULL(@HasDeletingAssetFixPermission, HasDeletingAssetFixPermission),
        HasCreatingAssetIssuePermission = ISNULL(@HasCreatingAssetIssuePermission, HasCreatingAssetIssuePermission),
        HasReadingAssetIssuePermission = ISNULL(@HasReadingAssetIssuePermission, HasReadingAssetIssuePermission),
        HasUpdatingAssetIssuePermission = ISNULL(@HasUpdatingAssetIssuePermission, HasUpdatingAssetIssuePermission),
        HasDeletingAssetIssuePermission = ISNULL(@HasDeletingAssetIssuePermission, HasDeletingAssetIssuePermission),
        HasCreatingBuildingPermission = ISNULL(@HasCreatingBuildingPermission, HasCreatingBuildingPermission),
        HasReadingBuildingPermission = ISNULL(@HasReadingBuildingPermission, HasReadingBuildingPermission),
        HasUpdatingBuildingPermission = ISNULL(@HasUpdatingBuildingPermission, HasUpdatingBuildingPermission),
        HasDeletingBuildingPermission = ISNULL(@HasDeletingBuildingPermission, HasDeletingBuildingPermission),
        HasCreatingCategoryPermission = ISNULL(@HasCreatingCategoryPermission, HasCreatingCategoryPermission),
        HasReadingCategoryPermission = ISNULL(@HasReadingCategoryPermission, HasReadingCategoryPermission),
        HasUpdatingCategoryPermission = ISNULL(@HasUpdatingCategoryPermission, HasUpdatingCategoryPermission),
        HasDeletingCategoryPermission = ISNULL(@HasDeletingCategoryPermission, HasDeletingCategoryPermission),
        HasCreatingCompanyPermission = ISNULL(@HasCreatingCompanyPermission, HasCreatingCompanyPermission),
        HasReadingCompanyPermission = ISNULL(@HasReadingCompanyPermission, HasReadingCompanyPermission),
        HasUpdatingCompanyPermission = ISNULL(@HasUpdatingCompanyPermission, HasUpdatingCompanyPermission),
        HasDeletingCompanyPermission = ISNULL(@HasDeletingCompanyPermission, HasDeletingCompanyPermission),
        HasCreatingDepartmentPermission = ISNULL(@HasCreatingDepartmentPermission, HasCreatingDepartmentPermission),
        HasReadingDepartmentPermission = ISNULL(@HasReadingDepartmentPermission, HasReadingDepartmentPermission),
        HasUpdatingDepartmentPermission = ISNULL(@HasUpdatingDepartmentPermission, HasUpdatingDepartmentPermission),
        HasDeletingDepartmentPermission = ISNULL(@HasDeletingDepartmentPermission, HasDeletingDepartmentPermission),
        HasCreatingEmployeePermission = ISNULL(@HasCreatingEmployeePermission, HasCreatingEmployeePermission),
        HasReadingEmployeePermission = ISNULL(@HasReadingEmployeePermission, HasReadingEmployeePermission),
        HasUpdatingEmployeePermission = ISNULL(@HasUpdatingEmployeePermission, HasUpdatingEmployeePermission),
        HasDeletingEmployeePermission = ISNULL(@HasDeletingEmployeePermission, HasDeletingEmployeePermission),
        HasCreatingEndUserPermission = ISNULL(@HasCreatingEndUserPermission, HasCreatingEndUserPermission),
        HasReadingEndUserPermission = ISNULL(@HasReadingEndUserPermission, HasReadingEndUserPermission),
        HasUpdatingEndUserPermission = ISNULL(@HasUpdatingEndUserPermission, HasUpdatingEndUserPermission),
        HasDeletingEndUserPermission = ISNULL(@HasDeletingEndUserPermission, HasDeletingEndUserPermission),
        HasCreatingEndUserRolePermission = ISNULL(@HasCreatingEndUserRolePermission, HasCreatingEndUserRolePermission),
        HasReadingEndUserRolePermission = ISNULL(@HasReadingEndUserRolePermission, HasReadingEndUserRolePermission),
        HasUpdatingEndUserRolePermission = ISNULL(@HasUpdatingEndUserRolePermission, HasUpdatingEndUserRolePermission),
        HasDeletingEndUserRolePermission = ISNULL(@HasDeletingEndUserRolePermission, HasDeletingEndUserRolePermission),
        HasCreatingLocationPermission = ISNULL(@HasCreatingLocationPermission, HasCreatingLocationPermission),
        HasReadingLocationPermission = ISNULL(@HasReadingLocationPermission, HasReadingLocationPermission),
        HasUpdatingLocationPermission = ISNULL(@HasUpdatingLocationPermission, HasUpdatingLocationPermission),
        HasDeletingLocationPermission = ISNULL(@HasDeletingLocationPermission, HasDeletingLocationPermission),
        HasCreatingManufacturerPermission = ISNULL(@HasCreatingManufacturerPermission, HasCreatingManufacturerPermission),
        HasReadingManufacturerPermission = ISNULL(@HasReadingManufacturerPermission, HasReadingManufacturerPermission),
        HasUpdatingManufacturerPermission = ISNULL(@HasUpdatingManufacturerPermission, HasUpdatingManufacturerPermission),
        HasDeletingManufacturerPermission = ISNULL(@HasDeletingManufacturerPermission, HasDeletingManufacturerPermission),
        HasCreatingProductPermission = ISNULL(@HasCreatingProductPermission, HasCreatingProductPermission),
        HasReadingProductPermission = ISNULL(@HasReadingProductPermission, HasReadingProductPermission),
        HasUpdatingProductPermission = ISNULL(@HasUpdatingProductPermission, HasUpdatingProductPermission),
        HasDeletingProductPermission = ISNULL(@HasDeletingProductPermission, HasDeletingProductPermission),
        HasCreatingProductSetPermission = ISNULL(@HasCreatingProductSetPermission, HasCreatingProductSetPermission),
        HasReadingProductSetPermission = ISNULL(@HasReadingProductSetPermission, HasReadingProductSetPermission),
        HasUpdatingProductSetPermission = ISNULL(@HasUpdatingProductSetPermission, HasUpdatingProductSetPermission),
        HasDeletingProductSetPermission = ISNULL(@HasDeletingProductSetPermission, HasDeletingProductSetPermission),
        HasCreatingRolePermission = ISNULL(@HasCreatingRolePermission, HasCreatingRolePermission),
        HasReadingRolePermission = ISNULL(@HasReadingRolePermission, HasReadingRolePermission),
        HasUpdatingRolePermission = ISNULL(@HasUpdatingRolePermission, HasUpdatingRolePermission),
        HasDeletingRolePermission = ISNULL(@HasDeletingRolePermission, HasDeletingRolePermission),
        HasReadingStoredProcedureLogPermission = ISNULL(@HasReadingStoredProcedureLogPermission, HasReadingStoredProcedureLogPermission),
        HasDeletingStoredProcedureLogPermission = ISNULL(@HasDeletingStoredProcedureLogPermission, HasDeletingStoredProcedureLogPermission),
        HasCreatingVendorPermission = ISNULL(@HasCreatingVendorPermission, HasCreatingVendorPermission),
        HasReadingVendorPermission = ISNULL(@HasReadingVendorPermission, HasReadingVendorPermission),
        HasUpdatingVendorPermission = ISNULL(@HasUpdatingVendorPermission, HasUpdatingVendorPermission),
        HasDeletingVendorPermission = ISNULL(@HasDeletingVendorPermission, HasDeletingVendorPermission)
    OUTPUT
        INSERTED.Id,
        INSERTED.Name,
        ...
        DELETED.HasCreatingAssetFixPermission AS OldHasCreatingAssetFixPermission,
        DELETED.HasReadingAssetFixPermission AS OldHasReadingAssetFixPermission,
        DELETED.HasUpdatingAssetFixPermission AS OldHasUpdatingAssetFixPermission,
        DELETED.HasDeletingAssetFixPermission AS OldHasDeletingAssetFixPermission,
        DELETED.HasCreatingAssetIssuePermission AS OldHasCreatingAssetIssuePermission,
        DELETED.HasReadingAssetIssuePermission AS OldHasReadingAssetIssuePermission,
        DELETED.HasUpdatingAssetIssuePermission AS OldHasUpdatingAssetIssuePermission,
        DELETED.HasDeletingAssetIssuePermission AS OldHasDeletingAssetIssuePermission,
