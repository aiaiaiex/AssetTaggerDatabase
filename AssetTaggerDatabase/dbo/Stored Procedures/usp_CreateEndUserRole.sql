...
BEGIN
    ...
    VALUES (
        ...
        -- Permissions.
        -- Asset CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingAssetPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingAssetPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingAssetPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingAssetPermission, 0),
        -- Building CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingBuildingPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingBuildingPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingBuildingPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingBuildingPermission, 0),
        -- Category CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingCategoryPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingCategoryPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingCategoryPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingCategoryPermission, 0),
        -- Company CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingCompanyPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingCompanyPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingCompanyPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingCompanyPermission, 0),
        -- Department CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingDepartmentPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingDepartmentPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingDepartmentPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingDepartmentPermission, 0),
        -- Employee CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingEmployeePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingEmployeePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingEmployeePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingEmployeePermission, 0),
        -- EndUser CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingEndUserPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingEndUserPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingEndUserPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingEndUserPermission, 0),
        -- EndUserRole CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingEndUserRolePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingEndUserRolePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingEndUserRolePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingEndUserRolePermission, 0),
        -- Location CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingLocationPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingLocationPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingLocationPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingLocationPermission, 0),
        -- Manufacturer CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingManufacturerPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingManufacturerPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingManufacturerPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingManufacturerPermission, 0),
        -- Product CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingProductPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingProductPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingProductPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingProductPermission, 0),
        -- ProductSet CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingProductSetPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingProductSetPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingProductSetPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingProductSetPermission, 0),
        -- Role CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingRolePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingRolePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingRolePermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingRolePermission, 0),
        -- StoredProcedureLog R Permissions.
        [dbo].[udf_GetBitColumnValue](@HasReadingStoredProcedureLogPermission, 0),
        -- Vendor CRUD Permissions.
        [dbo].[udf_GetBitColumnValue](@HasCreatingVendorPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasReadingVendorPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasUpdatingVendorPermission, 0),
        [dbo].[udf_GetBitColumnValue](@HasDeletingVendorPermission, 0)
    );
END;
