...
BEGIN
    ...
    DECLARE @AssetFixDateStart04 DATETIME = '2000-01-04';
    DECLARE @AssetFixDateStart05 DATETIME = '2000-01-06';
    DECLARE @AssetFixDateStart06 DATETIME = '2000-01-05';

    DECLARE @AssetFixDateEnd01 DATETIME = '2000-01-01';
    DECLARE @AssetFixDateEnd02 DATETIME = '2000-01-02';
    DECLARE @AssetFixDateEnd03 DATETIME = '2000-01-03';
    DECLARE @AssetFixDateEnd04 DATETIME = '2000-01-04';
    DECLARE @AssetFixDateEnd05 DATETIME = '2000-01-06';
