...
CREATE PROCEDURE [test_Constraints].[test_FK_AssetTransfer_Asset]
AS
BEGIN
    ...
    EXEC tSQLt.ApplyConstraint '[dbo].[AssetTransfer]', '[FK_AssetTransfer_Asset]';
    ...
    INSERT INTO [dbo].[AssetTransfer] (AssetID) VALUES
    (NEWID());
END;